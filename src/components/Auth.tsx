...
export default function Auth() {
  const { login, verifyLogin, register, setUser } = useAuth();
    ...
    <div className="max-w-md w-full p-8 bg-white rounded-xl shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className="w-full py-3 bg-white border border-gray-300 text-gray-700 rounded-lg font-bold hover:bg-gray-50 flex items-center justify-center transition-colors"
        >
